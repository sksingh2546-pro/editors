...
export interface FabricObject extends FabricElement {
...
const initialCode: Code = {
	...
	data: "[{\"data\":\"https://cms.summitsignage.com/design-editor/1.png\",\"duration\":10},{\"data\":\"https://cms.summitsignage.com/design-editor/2.png\",\"duration\":10}]"
};

const Playlist = fabric.util.createClass(fabric.Rect, {
	type: 'element',
	superType: 'element',
...
Playlist.fromObject = (options: FabricObject, callback: (obj: FabricObject) => any) => {
	return callback(new Playlist(options.code, options));
};

// @ts-ignore
window.fabric.Playlist = Playlist;
