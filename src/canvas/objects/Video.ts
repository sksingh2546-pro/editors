...
const Video = fabric.util.createClass(fabric.Rect, {
	...
	setSrc(src: string) {
		...
		setTimeout(()=>{
			if(document.getElementById(id+"_youtube_iframe")){
				document.getElementById(id+"_youtube_iframe").style.width="100%"
				document.getElementById(id+"_youtube_iframe").style.height="100%"
			}
		})
	},
