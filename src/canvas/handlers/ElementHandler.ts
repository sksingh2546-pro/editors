...
import { RatingObject } from '../objects/Rating';
import { IframeObject } from '../objects/Iframe';
import { WeatherObject } from '../objects/Weather';
import { ClockObject } from '../objects/Clock';
import { ElementObject } from '../objects/Element';
import { FabricObject } from '../objects/Ticker';
import {ImageScrollObject} from '../objects/ImageScroll'

export type ElementType = 'container' | 'script' | 'style';

export type ElementObjectType = VideoObject|IframeObject | ChartObject | RatingObject | ElementObject|WeatherObject|ClockObject|FabricObject|ImageScrollObject;
